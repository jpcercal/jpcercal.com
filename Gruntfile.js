module.exports = function (grunt) {
    ...
    //                 dot: true,
    //                 src: [
    //                     '<%= dist_css_path %>/<%= package.name %>.css',
    //                     '<%= dist_css_path %>/<%= package.name %>.css.map',
    ...
    //         js: {
    //             src: [
    //                 '<%= src_app_path %>/<%= js_path %>/<%= package.name %>.js'
    //             ],
    //             dest: '<%= dist_js_path %>/<%= package.name %>.js'
    //         },
    //         search: {
    //             src: [
    //                 '<%= src_app_path %>/<%= js_path %>/search.js'
    //             ],
    //             dest: '<%= dist_js_path %>/<%= package.name %>.search.js'
    //         },
    //         contact: {
    //             src: [
    //                 '<%= src_app_path %>/<%= js_path %>/contact.js'
    //             ],
    //             dest: '<%= dist_js_path %>/<%= package.name %>.contact.js'
    //         }
    //     },
    ...
    //         dist: {
    //             files: {
    //                 '<%= dist_css_path %>/syntax-highlight.css': '<%= src_less_path %>/<%= package.name %>.less'
    //             }
    //         }
    //     },
    ...
    //                 '<%= dist_css_path %>/<%= package.name %>.css': '<%= src_scss_path %>/<%= package.name %>.scss'
    //             }
    //         }
    //     },
    ...
    //         dist: {
    //             files: {
    //                 '<%= dist_css_path %>/<%= package.name %>.min.css': [
    //                     '<%= dist_css_path %>/<%= package.name %>.css',
    //                 ],
